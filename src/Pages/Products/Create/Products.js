...
function Products() {
    ...
    return (
        ...
        >
            ...
            />
            <button onClick={()=>setModalOpen(true)} className='hover:bg-green-200 lg:ms-[20px] lg:mt-[10px] lg:mb-[60px] mt-[60px] bg-green-300 focus-visible:outline-none w-[90%]  m-auto lg:w-[200px] lg:h-[33px] h=[40px] createElement'>{t('Yangi mahsulot qo\'shish')}</button>
            {/* Form */}
            {
            ...
            <div className={'flex flex-wrap justify-evenly items-center mainPadding'}>
                <div className={'flex gap-[1rem] mb-[15px] '}>
